...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin', 'current-module']], function () {
        ...
        Route::group(['prefix' => 'notification', 'as' => 'notification.', 'middleware' => ['module:notification']], function () {
            Route::get('/get-client-segments', [NotificationController::class, 'getClientSegments'])->name('get-segments');
            Route::get('/get-store-vouchers', [NotificationController::class, 'getStoreVouchers'])->name('get-store-vouchers');
