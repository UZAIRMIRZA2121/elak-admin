...
Route::group(['namespace' => 'Vendor', 'as' => 'vendor.'], function () {
    ...
    Route::group(['middleware' => ['vendor']], function () {
        ...
        Route::group(['prefix' => 'order', 'as' => 'order.', 'middleware' => ['module:order']], function () {
            ...
            Route::post('/scan-update', 'OrderController@orderScanUpdate')->name('scan');



        });

        Route::group(['prefix' => 'flateorder', 'as' => 'flate.order.', 'middleware' => ['module:order']], function () {
            Route::get('list/{status}', 'OrderController@flat_list')->name('list');

            Route::get('update-status/{id}/{status}', 'OrderController@updateStatus')->name('update-status');
            ...
            Route::get('/order-placed', 'OrderController@orderPlaced')->name('placed');
