...
@section('content')
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-end">
                ...
                <div class="col-sm-auto">
                    <a class="btn btn-primary" href="{{ route('customer.dashboard') }}">
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <form action="{{ route('customer.settings') }}" method="post"
                    enctype="multipart/form-data" id="customer-settings-form">
                    @csrf
                    <!-- Card -->
                    <!-- Card -->
                    <div class="card mb-3 mb-lg-5" id="generalDiv">
                        ...
                        <div class="profile-cover">
                            <div class="profile-cover-img-wrapper">
                                <img id="coverViewer" class="profile-cover-img"
                                    src="{{ asset(auth('customer')->user()->cover) }}"
                                    alt="Image"
                                    onerror="this.src='{{ asset('public/assets/admin/img/160x160/img1.jpg') }}'">
                            </div>
                            <div class="profile-cover-content profile-cover-btn p-3">
                                <div class="custom-file-btn">
                                    <input type="file" class="js-file-attach custom-file-btn-input" id="coverUploader"
                                        name="cover" accept=".webp, .jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                    <label class="custom-file-btn-label btn btn-white mb-0" for="coverUploader">
                                        <i class="tio-camera mr-2"></i>
                                        <span>{{ translate('messages.change_cover') }}</span>
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <label class="avatar avatar-xxl avatar-circle avatar-border-lg avatar-uploader profile-cover-avatar"
                            ...
                            <input type="file" name="logo" class="js-file-attach avatar-uploader-input"
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-sm-down-break">
                                        <input type="text" class="form-control" name="name" id="nameLabel"
                                            placeholder="{{ translate('messages.your_name') }}"
                                            aria-label="{{ translate('messages.your_name') }}"
                ...
                <div id="passwordDiv" class="card mb-3 mb-lg-5">
                    ...
                    <div class="card-body">
                        <!-- Form -->
                        <form id="changePasswordForm" action="{{ route('customer.settings-password') }}" method="post" enctype="multipart/form-data">
                            @csrf

                            <!-- Form Group -->
                            <div class="row form-group">
                                <label for="oldPassword" class="col-sm-3 col-form-label input-label">{{ translate('messages.old_password') }}</label>
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        <input type="password" class="js-toggle-password form-control" name="old_password" id="oldPassword"
                                            placeholder="{{ translate('messages.enter_old_password') }}" required
                                            data-hs-toggle-password-options='{
                                            "target": ".js-toggle-password-target-old",
                                            "defaultClass": "tio-hidden-outlined",
                                            "showClass": "tio-visible-outlined",
                                            "classChangeTarget": ".js-toggle-passowrd-show-icon-old"
                                            }'>
                                        <div class="js-toggle-password-target-old input-group-append">
                                            <a class="input-group-text" href="javascript:">
                                                <i class="js-toggle-passowrd-show-icon-old tio-visible-outlined"></i>
                                            </a>
                                        </div>
                                    </div>
                                </div>
