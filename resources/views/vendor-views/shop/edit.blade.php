                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                        ...
                                        <div class="lang_form" id="default-form">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name[]" id="default_name" class="form-control"
                                                    readonly placeholder="{{ translate('messages.' . $title . '_name') }}"
                                            ...
                                            <div class="form-group mb-0">
                                                ...
                                                <textarea type="text" name="address[]" readonly placeholder="{{ translate('messages.' . $title) }}"
                                                    class="form-control min-h-90px ckeditor">{{ $shop->getRawOriginal('address') }}</textarea>
                                            </div>
                                        </div>
                                        @foreach (json_decode($language) as $lang)
                                            <?php
                                            ...
                                            <div class="d-none lang_form" id="{{ $lang }}-form">
                                                ...
                                                <div class="form-group mb-0">
                                                    ...
                                                    <textarea type="text" name="address[]" readonly placeholder="{{ translate('messages.store') }}"
                                    ...
                                    <div class="form-group mt-2">
                                        <label for="name">{{ translate('messages.contact_number') }}<span
                                                class="text-danger">*</span></label>
                                        <input type="text" name="contact" value="{{ $shop->phone }}" readonly
                                            class="form-control" id="name" required>
                                    </div>
                                    <div class="mt-2">

                                        <label>
                                            {{ translate('messages.is_active_?') }}
                                            <span class="text-danger">*</span>
                                        </label>

                                        <!-- This will send 0 if checkbox is unchecked -->
                                        <input type="hidden" name="active" value="0">

                                        <label class="toggle-switch toggle-switch-sm">
                                            <input type="checkbox" name="active" value="1"
                                                class="toggle-switch-input" {{ $shop->active == 1 ? 'checked' : '' }}>
