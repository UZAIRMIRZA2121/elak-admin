                    ...
                    <div class="col-sm-6 col-md-4">
                        <div class="select-item">
                            <select name="category_id" data-url="{{ url()->full() }}" data-filter="type"
                                ...
                                class="form-control max-lg-h-40px set-filter">
                                ...
                                @if ($item->voucher_ids == 'Delivery/Pickup')
                                    <label class="toggle-switch toggle-switch-sm"
                                        ...
                                        <input type="checkbox" data-id="{{ $item->id }}"
                                            ...
                                            class="toggle-switch-input voucher-availability-toggle"
                                            id="voucherAvailability{{ $item->id }}"
                                            {{ !$item->voucherAvailability ? 'checked' : '' }}>
...
@push('script_2')
    <script>
        $(document).on('change', '.voucher-availability-toggle', function() {
            let checkbox = $(this);
