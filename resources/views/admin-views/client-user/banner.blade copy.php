                            ...
                            @if ($language)
                                <div class="row">
                                  ...
                                  <div class="col-6 col-md-4">
                                    <div class="lang_form" id="default-form">
                                            <div class="form-group">
                                                <label class="input-label" for="types_banner"> Type </label>
                                                <select name="types_banner" id="types_banner" class="form-control">
                                                    <option value="">-- Select Type --</option>
                                                    <option value="top" {{ request('types_banner') == 'top' ? 'selected' : '' }}>Top</option>
                                                    <option value="middle" {{ request('types_banner') == 'middle' ? 'selected' : '' }}>Middel</option>
                                                    <option value="bottom" {{ request('types_banner') == 'bottom' ? 'selected' : '' }}>Bottom</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn--container justify-content-center">
                                        ...
                                        <form action="{{ route('admin.client-side.delete_banner', [$Banner->id]) }}"
