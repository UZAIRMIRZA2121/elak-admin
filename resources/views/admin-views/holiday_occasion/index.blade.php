    ...
    <div class="content container-fluid">
        ...
        <div class="row g-3">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{route('admin.HolidayandOccasion.store')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            @if ($language)
                                <div class="row">
                                    <div class="col-6 ">
                ...
                <div class="card">
                    <div class="card-header py-2 border-0">
                        <div class="search--button-wrapper">
                            <h5 class="card-title">
                                Holiday & Occasion<span class="badge badge-soft-dark ml-2" id="itemCount"></span>
                            </h5>
                            <form  class="search-form">
                                ...
                                <div class="input-group input--group">
                                    <input id="datatableSearch_" value="{{ request()?->search ?? null }}" type="search" name="search" class="form-control"
                                            placeholder="Ex: Holiday & Occasion" aria-label="Search" >
                    ...
                    <div class="table-responsive datatable-custom">
                        <table id="columnSearchDatatable"
                            ...
                            <tbody id="set-rows">
                         @foreach($HolidayOccasion as $key => $item)
                            <tr>
                                {{-- Serial No --}}
                                <td class="text-center">
                                    <span class="mr-3">
                                        {{ $HolidayOccasion->firstItem() + $key }}
                                    </span>
                                </td>
                                ...
                                <td class="text-center">
                                    ...
                                    <form action="{{ route('admin.HolidayandOccasion.status', [$item->id]) }}"
                                ...
                                <td>
                                    <div class="btn--container justify-content-center">
                                        ...
                                        href="{{ route('admin.HolidayandOccasion.edit', [$item->id]) }}"
                                        title="Edit">
                                        <i class="tio-edit"></i>
                                        </a>
                                        ...
                                        <form action="{{ route('admin.HolidayandOccasion.delete', [$item->id]) }}"
                    ...
                    @if(count($HolidayOccasion) !== 0)
                    <hr>
                    @endif
                    <div class="page-area">
                        {!! $HolidayOccasion->links() !!}
                    </div>
                    @if(count($HolidayOccasion) === 0)
