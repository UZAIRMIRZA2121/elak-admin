...
@section('title'," Holiday & Occasion Edit")
...
<style>
    ...
    <div class="content container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{route('admin.HolidayandOccasion.update',[$HolidayandOccasion['id']])}}" method="post" enctype="multipart/form-data">
                    @csrf
                                    ...
                                    <div class="col-6 ">
                                        <div class="lang_form" id="default-form">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" value="{{$HolidayandOccasion->name}}" id="name" class="form-control"  placeholder="Enter Gift Occasions">
                                            </div>
