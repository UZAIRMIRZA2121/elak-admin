                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <div class="position-relative">
                                ...
                                <input type="text" data-title="{{ translate('Select_Order_Date_Range') }}"
                                    data-startDate="09/04/2024" data-endDate="09/24/2024" readonly name="order_date"
                                    value="{{ request()->get('order_date') ?? null }}"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="position-relative">
                                <span class="tio-calendar icon-absolute-on-right"></span>
                                <input type="text" data-title="{{ translate('Select_Customer_Joining_Date_Range') }}"
                                    readonly name="join_date" value="{{ request()->get('join_date') ?? null }}"
                                    class="date-range-picker form-control">
                            </div>
                        </div>
                        <div class="col-md-4">
                        ...
                        <tbody id="set-rows">
                            @foreach ($customers as $key => $customer)
                                <tr class="">
                                    ...
                                    <td>
                                        <label class="badge">
                                            {{ \App\CentralLogics\Helpers::date_format($customer->activated_at) }}
                                        </label>
                                    </td>
                                    <td>
                                        <label class="badge">
                                            {{ \App\CentralLogics\Helpers::date_format($customer->expire_at) }}
                                        </label>
                                    </td>
                                    <td>
