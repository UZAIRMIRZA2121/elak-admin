                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    <tr data-day="Monday">
                                                        <td>Monday</td>
                                                        <td>
                                                            <input type="time" class="form-control start-time" name="working_hours[monday][start]">
                                                        </td>
                                                        <td>
                                                            <input type="time" class="form-control end-time" name="working_hours[monday][end]">
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr data-day="Tuesday">
                                                        <td>Tuesday</td>
                                                        <td>
                                                            <input type="time" class="form-control start-time" name="working_hours[tuesday][start]">
                                                        </td>
                                                        <td>
                                                            <input type="time" class="form-control end-time" name="working_hours[tuesday][end]">
                                                        </td>
                                                        <td>
                                                            <button type="button" class="btn btn-outline-danger btn-sm reset-day">Reset</button>
                                                        </td>
                                                    ...
                                                    <tr data-day="Wednesday">
                                                        <td>Wednesday</td>
                                                        <td>
                                                            <input type="time" class="form-control start-time" name="working_hours[wednesday][start]">
                                                        </td>
                                                        <td>
                                                            <input type="time" class="form-control end-time" name="working_hours[wednesday][end]">
                                                        </td>
                                                        <td>
                                                            <button type="button" class="btn btn-outline-danger btn-sm reset-day">Reset</button>
                                                        </td>
                                                    ...
                                                    <tr data-day="Thursday">
                                                        <td>Thursday</td>
                                                        <td>
                                                            <input type="time" class="form-control start-time" name="working_hours[thursday][start]">
                                                        </td>
                                                        <td>
                                                            <input type="time" class="form-control end-time" name="working_hours[thursday][end]">
                                                        </td>
                                                        <td>
                                                            <button type="button" class="btn btn-outline-danger btn-sm reset-day">Reset</button>
                                                        </td>
                                                    ...
                                                    <tr data-day="Friday">
                                                        <td>Friday</td>
                                                        <td>
                                                            <input type="time" class="form-control start-time" name="working_hours[friday][start]">
                                                        </td>
                                                        <td>
                                                            <input type="time" class="form-control end-time" name="working_hours[friday][end]">
                                                        </td>
                                                        <td>
                                                            <button type="button" class="btn btn-outline-danger btn-sm reset-day">Reset</button>
                                                        </td>
                                                    ...
                                                    <tr data-day="Saturday">
                                                        <td>Saturday</td>
                                                        <td>
                                                            <input type="time" class="form-control start-time" name="working_hours[saturday][start]">
                                                        </td>
                                                        <td>
                                                            <input type="time" class="form-control end-time" name="working_hours[saturday][end]">
                                                        </td>
                                                        <td>
                                                            <button type="button" class="btn btn-outline-danger btn-sm reset-day">Reset</button>
                                                        </td>
                                                    ...
                                                    <tr data-day="Sunday">
                                                        <td>Sunday</td>
                                                        <td>
                                                            <input type="time" class="form-control start-time" name="working_hours[sunday][start]">
                                                        </td>
                                                        <td>
                                                            <input type="time" class="form-control end-time" name="working_hours[sunday][end]">
                                                        </td>
                                                        <td>
                                                            <button type="button" class="btn btn-outline-danger btn-sm reset-day">Reset</button>
                                                        </td>
                                        ...
                                        <div class="form-group mt-4">
                                            ...
                                            <p style="font-size: 13px; color: #666;">Custom Blackout Dates</p>
                                                ...
                                                @foreach ($CustomBlackoutData as $item)
                                                    <div class="holiday-checkbox">
                                                        <input type="checkbox" id="excludeNational_{{ $item->id}}" name="custom_blackout_dates[]" value="{{ $item->id}}">
                                                        <label for="excludeNational_{{ $item->id}}">  {{ $item->description}}</label>
                                                    </div>
                                                @endforeach
                                ...
                                <div class="condition-card">
                                    ...
                                    <div class="collapse show condition-body" id="generalRestrictions">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="age_restriction" id="ageRestriction_{{ $item->id}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="group_size" id="groupSize_{{ $item->id}}">
                                                <option value="">No requirement</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="usage-row">
                                                ...
                                                <div class="form-group">
                                                    <select class="form-control" name="user_limit[]" id="userPeriod_{{ $item->id}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="usage-row">
                                                ...
                                                <span class="times-label">times</span>
                                                <div class="form-group">
                                                    <select class="form-control" name="store_limit[]" id="storePeriod_{{ $item->id}}">
                                                        <option value="">Select period</option>
                                                        @foreach ($UsagePeriod as $item)
                                                        <option value="{{ $item->id}}"> {{ $item->name_en}}</option>
                                                        @endforeach
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="validity_after" id="validityAfter{{ $item->id}}">
