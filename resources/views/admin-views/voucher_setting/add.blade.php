                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-7">
                                    ...
                                    <div class="condition-card">
                                        <div class="condition-header" data-bs-toggle="collapse"
                                            data-bs-target="#timeConditions">
                                            <div class="condition-title">
                                        ...
                                        <div class="collapse show condition-body" id="timeConditions">
                                            ...
                                            <div class="form-group">
                                                <div class="custom-control custom-checkbox">
                                                    ...
                                                    <label class="custom-control-label" for="validityPeriod">Validity
                                                        Period</label>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" class="form-control"
                                                            name="validity_period[start]" id="startDate">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" class="form-control"
                                                            name="validity_period[end]" id="endDate">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group mt-3">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" checked class="custom-control-input"
                                                        id="specificDays" name="specific_days">
                                                    <label class="custom-control-label" for="specificDays">Specific Days of
                                                        Week</label>
                                                </div>
                                            </div>
                                                ...
                                                <table class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                        <tr data-day="Monday">
                                                            ...
                                                            <td>
                                                                <input type="time"
                                                                    value="{{ $working_hours['monday']['start'] ?? '' }}"
                                                                    class="form-control start-time"
                                                                    name="working_hours[monday][start]">
                                                            </td>
                                                            <td>
                                                                <input type="time"
                                                                    value="{{ $working_hours['monday']['end'] ?? '' }}"
                                                                    class="form-control end-time"
                                                                    name="working_hours[monday][end]">
                                                            </td>
                                                            <td>
                                                                <button type="button"
                                                                    class="btn btn-outline-danger btn-sm reset-day">Reset</button>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr data-day="Tuesday">
                                                            ...
                                                            <td>
                                                                <input type="time"
                                                                    value="{{ $working_hours['tuesday']['start'] ?? '' }}"
                                                                    class="form-control start-time"
                                                                    name="working_hours[tuesday][start]">
                                                            </td>
                                                            <td>
                                                                <input type="time"
                                                                    value="{{ $working_hours['tuesday']['end'] ?? '' }}"
                                                                    class="form-control end-time"
                                                        ...
                                                        <tr data-day="Wednesday">
                                                            ...
                                                            <td>
                                                                <input type="time"
                                                                    value="{{ $working_hours['wednesday']['start'] ?? '' }}"
                                                                    class="form-control start-time"
                                                                    name="working_hours[wednesday][start]">
                                                            </td>
                                                            <td>
                                                                <input type="time"
                                                                    value="{{ $working_hours['wednesday']['end'] ?? '' }}"
                                                                    class="form-control end-time"
                                                        ...
                                                        <tr data-day="Thursday">
                                                            ...
                                                            <td>
                                                                <input type="time"
                                                                    value="{{ $working_hours['thursday']['start'] ?? '' }}"
                                                                    class="form-control start-time"
                                                                    name="working_hours[thursday][start]">
                                                            </td>
                                                            <td>
                                                                <input type="time"
                                                                    value="{{ $working_hours['thursday']['end'] ?? '' }}"
                                                                    class="form-control end-time"
                                                        ...
                                                        <tr data-day="Friday">
                                                            ...
                                                            <td>
                                                                <input type="time"
                                                                    value="{{ $working_hours['friday']['start'] ?? '' }}"
                                                                    class="form-control start-time"
                                                                    name="working_hours[friday][start]">
                                                            </td>
                                                            <td>
                                                                <input type="time"
                                                                    value="{{ $working_hours['friday']['end'] ?? '' }}"
                                                                    class="form-control end-time"
                                                        ...
                                                        <tr data-day="Saturday">
                                                            ...
                                                            <td>
                                                                <input type="time"
                                                                    value="{{ $working_hours['saturday']['start'] ?? '' }}"
                                                                    class="form-control start-time"
                                                                    name="working_hours[saturday][start]">
                                                            </td>
                                                            <td>
                                                                <input type="time"
                                                                    value="{{ $working_hours['saturday']['end'] ?? '' }}"
                                                                    class="form-control end-time"
                                                        ...
                                                        <tr data-day="Sunday">
                                                            ...
                                                            <td>
                                                                <input type="time"
                                                                    value="{{ $working_hours['sunday']['start'] ?? '' }}"
                                                                    class="form-control start-time"
                                                                    name="working_hours[sunday][start]">
                                                            </td>
                                                            <td>
                                                                <input type="time"
                                                                    value="{{ $working_hours['sunday']['end'] ?? '' }}"
                                                                    class="form-control end-time"
                                                ...
                                                @foreach ($HolidayOccasion as $item)
                                                    <div class="holiday-checkbox">
                                                        <input type="checkbox" id="excludeNational_{{ $item->id }}"
                                                            name="exclude_national[]" value="{{ $item->id }}">
                                                        <label for="excludeNational_{{ $item->id }}">
                                                            {{ $item->name_en }}</label>
                                                    </div>
                                                @endforeach
                                            ...
                                            <div class="form-group mt-4">
                                                ...
                                                @foreach ($CustomBlackoutData as $item)
                                                    <div class="holiday-checkbox">
                                                        <input type="checkbox"
                                                            id="custom_blackout_dates_{{ $item->id }}"
                                                            name="custom_blackout_dates[]" value="{{ $item->id }}">
                                                        <label for="custom_blackout_dates_{{ $item->id }}">
                                    ...
                                    <div class="condition-card">
                                        <div class="condition-header" data-bs-toggle="collapse"
                                            data-bs-target="#generalRestrictions">
                                            <div class="condition-title">
                                        ...
                                        <div class="collapse show condition-body" id="generalRestrictions">
                                            ...
                                            <div class="form-group">
                                                <div class="form-group mb-0">
                                                    ...
                                                    <select name="age_restriction[]" id="ageRestriction"
                                            ...
                                            <div class="form-group">
                                                <div class="form-group mb-0">
                                                    ...
                                                    <!-- Dropdown: Only Percent & Fixed -->
                                                    <select name="group_size[]" id="groupSize"
                                                        class="form-control js-select2-custom" multiple>
                                                        <option value="">No requirement</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="usage-row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" name="user_limit[created_at]"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="usage-row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" name="store_limit[created_at]"
                                                            value="{{ $items->created_at ?? '' }}">
                                                    </div>
                                                ...
                                                <div class="usage-row">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="number" class="form-control"
                                                            ...
                                                            placeholder="Number of Day" min="1">
                                                    </div>
    ...
    @endforeach
                                                ...
                                                @foreach ($GeneralRestriction as $item)
                                                    <div class="holiday-checkbox">
                                                        <input type="checkbox" id="noOtherOffers_{{ $item->id }}"
                                                            name="no_other_offers[]" value="{{ $item->id }}">
                                                        <label for="noOtherOffers_{{ $item->id }}">
                                                            {{ $item->name_en }}</label>
                                                    </div>
                                                @endforeach
                ...
                <div class="row g-3">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('admin.VoucherSetting.store') }}" method="post"
                                    id="conditionsForm">
                                    @csrf
                                    <!-- <input type="hidden" name="item_id" value="{{ request()->route('id') }}"> -->
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control">
                                            ...
                                            <input type="input" class="form-control"
                                                value="{{ $VoucherSetting->title_name ?? '' }}" id="title_name"
                                                name="title_name">
                                        </div>
                                    </div>
                                                ...
                                                <div class="collapse show condition-body" id="timeConditions">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="validityPeriod" name="validity_period[active]"
                                                                {{ isset($validityPeriod['active']) ? 'checked' : '' }}>
                                                            <label class="custom-control-label"
                                                                for="validityPeriod">Validity Period</label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group mt-3">
                                                        <div class="custom-control custom-checkbox">
                                                            ...
                                                            <label class="custom-control-label"
                                                                for="specificDays">Specific Days of Week</label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group mt-4">
                                                        ...
                                                        @foreach ($HolidayOccasion as $item)
                                                            <div class="holiday-checkbox">
                                                                <input type="checkbox"
                                                                    id="excludeNational_{{ $item->id }}"
                                                                    name="exclude_national[]" value="{{ $item->id }}"
                                                                    {{ in_array($item->id, (array) ($holidays ?? [])) ? 'checked' : '' }}>
                                                                <label
                                                                    for="excludeNational_{{ $item->id }}">{{ $item->name_en }}</label>
                                                            </div>
                                                        @endforeach
                                                    </div>
                                                    ...
                                                    <div class="form-group mt-4">
                                                        ...
                                                        @foreach ($CustomBlackoutData as $item)
                                                            <div class="holiday-checkbox">
                                                                ...
                                                                <label
                                                                    for="custom_blackout_dates_{{ $item->id }}">{{ $item->description }}</label>
                                                            </div>
                                                        @endforeach
                                            ...
                                            <div class="condition-card">
                                                <div class="condition-header" data-bs-toggle="collapse"
                                                    ...
                                                    <div class="condition-title">
                                                        <i class="tio-shield-outlined" style="font-size: 20px;"></i>
                                                        <span>General Restrictions</span>
                                                        <span class="active-badge" id="restrictionActiveCount">0
                                                            Active</span>
                                                    </div>
                                                    <i class="tio-chevron-down"></i>
                                                </div>
                                                <div class="collapse show condition-body" id="generalRestrictions">
                                                    ...
                                                    if (is_string($age_data)) {
                                                        $age_data = json_decode($age_data, true) ?? [];
                                                    }
                                                    ...
                                                    <div class="form-group">
                                                        <label class="input-label"
                                                            for="age_restriction">{{ translate('Age Restriction') }}</label>
                                                        <select name="age_restriction[]"
                                                            id="ageRestriction_{{ $setting->id ?? '' }}"
                                                            class="form-control js-select2-custom" multiple>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="input-label"
                                                            for="group_size">{{ translate('Group Size Requirement') }}</label>
                                                        <select name="group_size[]" id="groupSize"
                                                            class="form-control js-select2-custom" multiple>
    ...
    @endforeach
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        @foreach ($GeneralRestriction as $item)
                                                            <div class="holiday-checkbox">
                                                                <input type="checkbox"
                                                                    id="noOtherOffers_{{ $item->id }}"
                                                                    name="no_other_offers[]" value="{{ $item->id }}"
                                                                    {{ in_array($item->id, (array) ($generalRestrictions ?? [])) ? 'checked' : '' }}>
                                                                <label
                                                                    for="noOtherOffers_{{ $item->id }}">{{ $item->name_en }}</label>
                                                            </div>
                                                        @endforeach
                                        ...
                                        <div class="col-lg-5">
                                            <div class="preview-panel">
                                                ...
                                                <!-- Validity Period -->
                                                <div class="preview-section" id="previewValidityPeriod"
                                                    style="display:none;">
                                                    <div class="preview-label">Validity period:</div>
                                                    <div class="preview-value" id="previewValidityPeriodText">-</div>
                                                </div>
                                                ...
                                                <!-- previewCustomBlackout -->
                                                <div class="preview-section" id="previewCustomBlackout"
                                                    style="display:none;">
                                                    <div class="preview-label">Holiday restrictions:</div>
                                                    <div class="preview-value" id="previewCustomBlackoutText">-</div>
                                                </div>
                                                ...
                                                <!-- Limit per Store -->
                                                <div class="preview-section" id="previewStoreLimit"
                                                    style="display:none;">
                                                    <div class="preview-label">Limit per store:</div>
                                                    <div class="preview-value" id="previewStoreLimitText">-</div>
                                                </div>
                                                ...
                                                <!-- General Restrictions -->
                                                <div class="preview-section" id="previewRestrictions"
                                                    style="display:none;">
                                                    <div class="preview-label">General restrictions:</div>
                                                    <div class="preview-value" id="previewRestrictionsText">-</div>
                                                </div>
