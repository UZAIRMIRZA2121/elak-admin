                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-4">
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <small class="text-muted">Add and remove holidays available in
                                                conditions</small>
                                        </div>
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="holiday_name_ar"
                                                        name="holiday_name_ar" placeholder="Example: Ramadan">
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">English Name</label>
                                                    <input type="text" class="form-control" name="holiday_name_en"
                                                        id="holiday_name_en" placeholder="Example: Ramadan">
                                                </div>
                                                <div class="col-md-6 mb-3">
                                            ...
                                            <div class="mt-3">
                                                <label class="form-label text-muted">Current Holidays (<span
                                                        id="holidayCount">0</span>)</label>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">Arabic Name</label>
                                                    <input type="text" class="form-control" name="restriction_name_ar"
                                                        id="restriction_name_ar"
                                                        placeholder="Example: Cannot combine with other offers">
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">English Name</label>
                                                    <input type="text" class="form-control" name="restriction_name_en"
                                                        id="restriction_name_en"
                                                        placeholder="Example: Cannot combine with other offers">
                                                </div>
                                                <div class="col-md-12 mb-3">
                                                    <button type="button" class="btn btn-primary" name="addRestrictionBtn"
                                                        id="addRestrictionBtn">
                                                        <i class="fas fa-plus"></i> Add Restriction
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="mt-3">
                                                <label class="form-label text-muted">Current Restrictions (<span
                                                        id="restrictionCount">0</span>)</label>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="date" class="form-control" name="blackout_date"
                                                        id="blackout_date">
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">Description</label>
                                                    <input type="text" class="form-control"
                                                        name="blackout_description" id="blackout_description"
                                                        placeholder="Example: Company Anniversary">
                                                </div>
                                                <div class="col-md-12 mb-3">
                                                    <button type="button" class="btn btn-primary" name="addBlackoutBtn"
                                                        id="addBlackoutBtn">
                                            ...
                                            <div class="mt-3">
                                                <label class="form-label text-muted">Current Blackout Dates (<span
                                                        id="blackoutCount">0</span>)</label>
                                                <div id="blackoutTags" class="d-flex flex-wrap gap-2">
                                                    <p class="text-muted" id="noBlackoutMsg">No blackout dates. Add a new
                                                        date above.</p>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-12 mb-4">
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <small class="text-muted">Add and remove age restrictions available in
                                                conditions</small>
                                        </div>
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">Arabic Name</label>
                                                    <input type="text" class="form-control"
                                                        name="age_restriction_name_ar" id="age_restriction_name_ar"
                                                        placeholder="Example: 18+ Only">
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">English Name</label>
                                                    <input type="text" class="form-control"
                                                        name="age_restriction_name_en" id="age_restriction_name_en"
                                                        placeholder="Example: 18+ Only">
                                                </div>
                                                <div class="col-md-12 mb-3">
                                                    <button type="button" class="btn btn-primary"
                                                        name="addAgeRestrictionBtn" id="addAgeRestrictionBtn">
                                                        <i class="fas fa-plus"></i> Add Age Restriction
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="mt-3">
                                                <label class="form-label text-muted">Current Age Restrictions (<span
                                                        id="ageRestrictionCount">0</span>)</label>
                                ...
                                <div class="col-md-12 mb-4">
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <small class="text-muted">Add and remove group size requirements available in
                                                conditions</small>
                                        </div>
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    <button type="button" class="btn btn-primary" name="addGroupSizeBtn"
                                                        id="addGroupSizeBtn">
                                            ...
                                            <div class="mt-3">
                                                <label class="form-label text-muted">Current Group Size Requirements (<span
                                                        id="groupSizeCount">0</span>)</label>
                                ...
                                <div class="col-md-12 mb-4">
                                    <div class="card">
                                        <div class="card-header">
                                            <h5>Usage Periods</h5>
                                            <small class="text-muted">Add and remove usage periods available in
                                                conditions</small>
                                        </div>
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">Arabic Name</label>
                                                    <input type="text" class="form-control"
                                                        name="usage_period_name_ar" id="usage_period_name_ar"
                                                        placeholder="Example: Per Day">
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">English Name</label>
                                                    <input type="text" class="form-control"
                                                        name="usage_period_name_en" id="usage_period_name_en"
                                                        placeholder="Example: Per Day">
                                                </div>
                                                <div class="col-md-12 mb-3">
                                                    <button type="button" class="btn btn-primary"
                                                        name="addUsagePeriodBtn" id="addUsagePeriodBtn">
                                                        <i class="fas fa-plus"></i> Add Usage Period
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="mt-3">
                                                <label class="form-label text-muted">Current Usage Periods (<span
                                                        id="usagePeriodCount">0</span>)</label>
                                ...
                                <div class="col-md-12 mb-4">
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <small class="text-muted">Add and remove offer validity periods after
                                                purchase</small>
                                        </div>
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">Arabic Name</label>
                                                    <input type="text" class="form-control"
                                                        name="validity_period_name_ar" id="validity_period_name_ar"
                                                        placeholder="Example: 1 Month">
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">English Name</label>
                                                    <input type="text" class="form-control"
                                                        name="validity_period_name_en" id="validity_period_name_en"
                                                        placeholder="Example: 1 Month">
                                                </div>
                                                <div class="col-md-12 mb-3">
                                                    <button type="button" class="btn btn-primary"
                                                        name="addValidityPeriodBtn" id="addValidityPeriodBtn">
                                                        <i class="fas fa-plus"></i> Add Validity Period
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="mt-3">
                                                <label class="form-label text-muted">Current Validity Periods (<span
                                                        id="validityPeriodCount">0</span>)</label>
        ...
        `;
                    ...
                    $(document).on('click', '#restrictionTags .delete-tag', function() {
                        ...
                        deleteCondition(id, 'restriction', function() {
                            conditionsData.restrictions = conditionsData.restrictions.filter(r => r.id !=
                                id);
                            renderRestrictions();
                        });
                    });
                    ...
                    $(document).on('click', '#blackoutTags .delete-tag', function() {
                        ...
                        deleteCondition(id, 'blackout_date', function() {
                            conditionsData.blackoutDates = conditionsData.blackoutDates.filter(b => b.id !=
                                id);
                            renderBlackoutDates();
                        });
                    });
                    ...
                    $(document).on('click', '#ageRestrictionTags .delete-tag', function() {
                        ...
                        deleteCondition(id, 'age_restriction', function() {
                            conditionsData.ageRestrictions = conditionsData.ageRestrictions.filter(a => a
                                .id != id);
                            renderAgeRestrictions();
                        });
                    });
                    ...
                    $(document).on('click', '#groupSizeTags .delete-tag', function() {
                        ...
                        deleteCondition(id, 'group_size_requirement', function() {
                            conditionsData.groupSizeRequirements = conditionsData.groupSizeRequirements
                                .filter(g => g.id != id);
                            renderGroupSizes();
                        });
                    });
                    ...
                    $(document).on('click', '#usagePeriodTags .delete-tag', function() {
                        ...
                        deleteCondition(id, 'usage_period', function() {
                            conditionsData.usagePeriods = conditionsData.usagePeriods.filter(u => u.id !=
                                id);
                            renderUsagePeriods();
                        });
                    });
                    ...
                    $(document).on('click', '#validityPeriodTags .delete-tag', function() {
                        ...
                        deleteCondition(id, 'validity_period', function() {
                            conditionsData.validityPeriods = conditionsData.validityPeriods.filter(v => v
                                .id != id);
                            renderValidityPeriods();
                        });
                    });
