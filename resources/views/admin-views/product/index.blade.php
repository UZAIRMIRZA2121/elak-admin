    ...
    <div class="content container-fluid">
        ...
        <form action="javascript:" method="post" id="item_form" enctype="multipart/form-data">
            ...
            <div class="row g-2">
                ...
                <input type="hidden" name="hidden_food_and_product" value="{{ request()->get('name', 'Food') }}">

                @if (in_array(Config::get('module.current_module_type'), ['voucher']))

                    @if (request()->name == 'Food')
                        @include('admin-views.product.include_index_food')
                    @elseif (request()->name == 'Product')
                        @include('admin-views.product.include_index_product')
                    @endif
                @else
                    <div class="col-md-6">
                                    ...
                                    <div class="flex-grow-1 mx-auto">
                                        <label class="text-dark d-block mb-4 mb-xl-5">
                                            ...
                                            @if (Config::get('module.current_module_type') == 'food')
                                                <small class="">( {{ translate('messages.ratio') }} 1:1 )</small>
                                            @else
                                                <small class="text-danger">* ( {{ translate('messages.ratio') }} 1:1
                                                    )</small>
                                            @endif
                                        </label>
                            ...
                            <div class="card-body">
                                <div class="row g-2 align-items-end">
                                    ...
                                    @if (Config::get('module.current_module_type') == 'grocery' ||
                                            ...
                                            Config::get('module.current_module_type') == 'voucher')
                                        ...
                                        <div class="col-sm-6" id="allergy">
                                            ...
                                            <select name="allergies[]" class="form-control multiple-select2"
                                                ...
                                                @foreach (\App\Models\Allergy::select(['allergy'])->get() as $allergy)
                                                    <option value="{{ $allergy->allergy }}">{{ $allergy->allergy }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-sm-6 col-lg-3" id="basic">
                                        <div class="form-check mb-sm-2 pb-sm-1">
                                            <input class="form-check-input" name="basic" type="checkbox"
                                                value="1" id="flexCheckDefaultBasic" checked>
                                        ...
                                        <div class="col-sm-6 col-lg-3" id="is_prescription_required">
                                            <div class="form-check mb-sm-2 pb-sm-1">
                                                <input class="form-check-input" name="is_prescription_required"
                                                    type="checkbox" value="1" id="flexCheckDefaultprescription"
                                                    checked>
                                                ...
                                                @if (count(\App\Models\GenericName::select(['generic_name'])->get()) > 0)
                                                    <div class="dropdown-menu">
                                                        @foreach (\App\Models\GenericName::select(['generic_name'])->get() as $generic_name)
                                                            <div class="dropdown-item">{{ $generic_name->generic_name }}
                                                            </div>
                                                        @endforeach
                                                    </div>
                                                @endif
...
@push('script_2')
    ...
    <script>
        ...
        $(document).on('click', '.delete_input_button', function() {
            ...
            count--;
            if (count == 0) {
                $('#empty-variation').show();
                $('input[name="price"]').val(1).prop('readonly', false);
            }
            removeOption(e);
        });
                                ...
                                <div class="col-xl-4 col-lg-6">
                                    <div>
                                        ...
                                        <label class="form-check form--check mr-2 mr-md-4">
                                                <input class="form-check-input show_min_max" data-count="` + count +
                    `" type="radio" value="multi" name="options[` + count + `][type]" id="type` + count + `" checked>
                                                <span class="form-check-label">{{ translate('Multiple Selection') }}</span>
                                        </label>
                                        <label class="form-check form--check mr-2 mr-md-4">
                                                <input class="form-check-input hide_min_max" data-count="` + count +
                    `" type="radio" value="single"  name="options[` + count + `][type]" id="type` + count + `" >
        ...
        function multiples_category() {
            ...
            $.ajax({
                ...
                type: "GET",
                data: {
                    category_ids_all: category_ids_all
                },
                traditional: false,
                dataType: "json",
