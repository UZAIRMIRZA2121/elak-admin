...
@section('title'," Delivery List Edit")
...
<style>
    ...
    <div class="content container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{route('admin.DeliveryOption.update',[$DeliveryOption['id']])}}" method="post" enctype="multipart/form-data">
                    @csrf
                               ...
                               <div class="row">
                                    <div class="col-6 ">
                                        <div class="lang_form" id="default-form">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="title" value="{{$DeliveryOption->title}}" id="title" class="form-control"  placeholder="Enter Delivery List">
                                            </div>
                                  ...
                                  <div class="col-6 ">
                                        <div class="lang_form" id="default-form">
                                            <div class="form-group">
                                                <label class="input-label"
                                                    for="sub_titles">  Sub Title
                                                </label>
                                                <input type="text" name="sub_title" id="sub_title" class="form-control"  placeholder="Enter Sub Title" value="{{$DeliveryOption->sub_title}}">
                                            </div>
                                        </div>
                                    </div>
                                  ...
                                  {{-- <div class="col-6 ">
                                    <div class="form-group mb-0">
                                            ...
                                            <textarea type="text" name="des" placeholder="des" class="form-control min-h-90px ckeditor">{{$DeliveryOption->des}}</textarea>
                                        </div>
                                   </div> --}}
                                </div>
                        @endif
