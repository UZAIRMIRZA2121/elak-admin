    ...
    <div class="content container-fluid">
        ...
        <div class="row g-3">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{route('admin.DeliveryOption.store')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            @if ($language)
                                <div class="row">
                                    <div class="col-6 ">
                ...
                <div class="card">
                    <div class="card-header py-2 border-0">
                        <div class="search--button-wrapper">
                            <h5 class="card-title">
                                Delivery List<span class="badge badge-soft-dark ml-2" id="itemCount"></span>
                            </h5>
                            <form  class="search-form">
                                ...
                                <div class="input-group input--group">
                                    <input id="datatableSearch_" value="{{ request()?->search ?? null }}" type="search" name="search" class="form-control"
                                            placeholder="Ex: Delivery List" aria-label="Search" >
                    ...
                    <div class="table-responsive datatable-custom">
                        <table id="columnSearchDatatable"
                            ...
                            <tbody id="set-rows">
                         @foreach($DeliveryOption as $key => $item)
                            <tr>
                                {{-- Serial No --}}
                                <td class="text-center">
                                    <span class="mr-3">
                                        {{ $DeliveryOption->firstItem() + $key }}
                                    </span>
                                </td>
                                ...
                                <td class="text-center">
                                    ...
                                    <form action="{{ route('admin.DeliveryOption.status', [$item->id]) }}"
                                ...
                                <td>
                                    <div class="btn--container justify-content-center">
                                        ...
                                        href="{{ route('admin.DeliveryOption.edit', [$item->id]) }}"
                                        title="Edit">
                                        <i class="tio-edit"></i>
                                        </a>
                                        ...
                                        <form action="{{ route('admin.DeliveryOption.delete', [$item->id]) }}"
