                                    ...
                                    <div class="col-12 col-md-4">
                                        <div class="lang_form" id="default-form">
                                            <div class="form-group">
                                                <label class="input-label" for="name"> Mobile App Name
                                                </label>
                                    ...
                                    <div class="col-12 ">
                                        <div class="lang_form" id="default-form">
                                            <div class="form-group">
                                                ...
                                                <textarea name="descrption" id="descrption" class="form-control" rows="3" placeholder="Description"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    {{-- <div class="col-12 col-md-4">
                                        ...
                                        <div class="lang_form" id="default-form">
                                            <div class="form-group">
                                                ...
                                                @if (!empty($client->logo))
                                                    <div class="mt-2">
                                                        <img src="{{ asset($client->logo) }}" alt="Client Logo"
                ...
                <div class="card">
                    <div class="card-header py-2 border-0">
                        <div class="search--button-wrapper">
                            <h5 class="card-title">
                                Mobile App List<span class="badge badge-soft-dark ml-2"
                                    id="itemCount">{{ $Apps->total() }}</span>
                            </h5>
                            <form class="search-form">
                                ...
                                <div class="input-group input--group">
                                    <input id="datatableSearch_" value="{{ request()?->search ?? null }}" type="search"
                                        name="search" class="form-control" placeholder="Ex: segment Name"
                                        aria-label="Search">
                                        ...
                                        <td class="text-center">
                                            <label class="toggle-switch toggle-switch-sm"
                                                ...
                                                <input type="checkbox" class="toggle-switch-input dynamic-checkbox"
                                                    ...
                                                    data-id="status-{{ $App->id }}" data-type="status"
                                                    id="status-{{ $App->id }}">
                                                <span class="toggle-switch-label mx-auto">
                                                    <span class="toggle-switch-indicator"></span>
                                                </span>
                                            </label>
                                            <form action="{{ route('admin.app.status', [$App->id]) }}" method="post"
                                        ...
                                        <td>
                                            <div class="btn--container justify-content-center">
                                                ...
                                                <a class="btn action-btn btn--danger btn-outline-danger form-alert"
                                                    href="javascript:" data-id="client-{{ $App->id }}"
                                                    data-message="Want to delete this client ?" title="Delete">
                                                    <i class="tio-delete-outlined"></i>
                                                </a>
                                                <form action="{{ route('admin.app.delete', [$App->id]) }}" method="post"
                                                    id="client-{{ $App->id }}">
                                                    @csrf @method('delete')
                                                </form>
                                            </div>
