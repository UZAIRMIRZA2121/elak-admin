                                ...
                                <div class="lang_form" id="default-form">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" id="name" class="form-control"
                                            value="{{ $App->app_name }}" placeholder="Enter Segment Name">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="type" id="type" class="form-control">
                                            ...
                                            <option value="mobile_app"
                                                {{ $App->app_type == 'mobile_app' ? 'Selected' : '' }}>
                                                Mobile App</option>
                                            <option value="website" {{ $App->app_type == 'website' ? 'Selected' : '' }}>
                                                Website</option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="col-12  ">
                                <div class="lang_form" id="default-form">
                                    <div class="form-group">
                                        ...
                                        <textarea name="descrption" id="descrption" class="form-control" rows="3" placeholder="Description">{{ $App->app_dec }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="banner" id="banner" class="form-control">
                                            ...
                                            @foreach ($Banner as $item)
                                                <option value="{{ $item->id }}"
                                                    {{ $item->id == $App->banner ? 'Selected' : '' }}>{{ $item->type }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                        ...
                                        <select name="client_id" id="client_id" class="form-control">
                                            ...
                                            @foreach ($clients as $client)
                                                <option value="{{ $client->id }}"
                                                    {{ isset($App) && $App->client_id == $client->id ? 'selected' : '' }}>
                                                    {{ $client->name }}
                                                </option>
                                            @endforeach
