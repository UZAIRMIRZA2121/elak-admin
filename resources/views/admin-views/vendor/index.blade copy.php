                    ...
                    <div class="card-body">
                        ...
                        <div class="lang_form" id="default-form">
                            ...
                            <div class="form-group mb-0">
                                ...
                                <textarea name="address[]" placeholder="{{ translate('messages.store') }}"
                        ...
                        <div class="row g-3 my-0">
                            <div class="col-lg-4">
                                ...
                                <div class="form-group mb-5">
                                    ...
                                    <label class="switch">
                                        <input type="checkbox" id="type" name="type" value="1" {{ old('type')
                                            ? 'checked' : '' }}>
                            ...
                            <div class="col-lg-8">
                                ...
                                {{-- <div class="form-group " style="margin-top: 92px">
                                    ...
                                    <input type="text" id="bonus_tiers" name="bonus_tiers" class="form-control"
                                        placeholder="Bonus Tiers" required>
                                </div>
                                <div class="form-group">
                                    <label class="input-label" for="limit_from">{{translate('Limit From')}}</label>
                                    <input type="text" id="limit_from" name="limit_from" class="form-control"
                                        placeholder="Limit From" required>
                                </div>
                                <div class="form-group">
                                    <label class="input-label" for="limit_to">{{translate('Limit To')}}</label>
                                    <input type="text" id="limit_to" name="limit_to" class="form-control"
                                        placeholder="Limit To" required>
                                </div>
                                <div class="form-group">
                                    <label class="input-label" for="flate_discount">{{translate('Flate
                                        Discount')}}</label>
                                    <input type="text" id="flate_discount" name="flate_discount" class="form-control"
                                        placeholder="Flate Discount" required>
                                </div> --}}
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="js-form-message form-group mb-0">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <input type="password" class="js-toggle-password form-control" name="password"
                                            id="signupSrPassword" placeholder="{{ translate('messages.password') }}"
                                            aria-label="Password" required data-hs-toggle-password-options='{
                                ...
                                <div class="js-form-message form-group mb-0">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <input type="password" class="js-toggle-password form-control"
                                            ...
                                            aria-label="Confirm Password" required data-hs-toggle-password-options='{
                                                "target": [".js-toggle-password-target-1", ".js-toggle-password-target-2"],
                                                "defaultClass": "tio-hidden-outlined",
                                                "showClass": "tio-visible-outlined",
                ...
                <div>
                    <div class="card p-20">
                        <div class="mb-20">
                            ...
                            {{-- <p class="fz-12px mb-0">{{translate('Lorem ipsum dolor sit amet, consectetur adipiscing
                                elit.')}}</p> --}}
                        </div>
                        <div class="row g-3">
                            <div class="col-md-12">
...
<script>
    ...
    function addStaffRow() {
        ...
        const html = `
            <div class="row g-3 staff-row mb-3 p-3 border rounded" id="${rowId}">
                ...
                <div class="col-md-1 d-flex align-items-end">
                    <button type="button" class="btn btn-danger btn-sm" onclick="removeStaff('${rowId}')">
                        X
                    </button>
                </div>
            </div>
        ...
        document.getElementById("staffContainer").insertAdjacentHTML('beforeend', html);
    ...
    function updateHiddenField() {
        ...
        document.getElementById("staffDataInput").value = JSON.stringify(staffList);
    }
