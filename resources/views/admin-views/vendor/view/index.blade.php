                ...
                <div class="card h-100">
                    <div class="card-header">
                        <h5 class="card-title m-0 d-flex align-items-center">
                            ...
                            <span class="ml-1">{{ translate('Staff Info') }}</span>
                        </h5>
                    </div>
                    <div class="card-body">
                        <div class="resturant--info-address">
                            <ul class="address-info address-info-2 list-unstyled list-unstyled-py-3 text-dark">
                                @if ($store->staff_data)
                                    @foreach (json_decode($store->staff_data, true) as $staff)
                                        <li>
                                            <span> <strong>{{ translate('Name') }}</strong></span>
                                            <span>:</span> &nbsp; {{ $staff['name'] ?? translate('N/A') }}
                                        </li>
                                        <Ri>
                                            <span> <strong>{{ translate('Role') }}</strong></span>
                                            <span>:</span> &nbsp; {{ $staff['role'] ?? translate('N/A') }}
                                            </li>
                                            <li>
                                                <span> <strong>{{ translate('Phone') }}</strong></span>
                                                <span>:</span> &nbsp; {{ $staff['phone'] ?? translate('N/A') }}
                                            </li>
                                            <hr>
                                    @endforeach
                                @else
                                    <li>
                                        <span> <strong>{{ translate('Staff Info') }}</span></strong>
                                        <span>:</span> &nbsp; {{ translate('Have_n’t_added_Yet.') }}
                                    </li>
                                @endif
                ...
                <div class="card h-100">
                    <div class="card-header">
                        <h5 class="card-title m-0 d-flex align-items-center">
                            ...
                            <span class="ml-1">{{ translate('Agreements') }}</span>
                        </h5>
                    </div>
                                ...
                                <li>
                                    @if ($store->agreement_certificate_image)
                                        ...
                                        @foreach ($agreements as $agreement)
                                            ...
                                            <a href="{{ asset('public/storage/store/' . $agreement) }}" target="_blank">
