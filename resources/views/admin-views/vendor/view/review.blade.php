                            ...
                            "paging":false
                                ...
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th class="text-center w-100px">{{ translate('messages.visibility') }}</th>
                                    ...
                                    @foreach ($reviews as $key => $review)
                                        <tr id="review-row-{{ $review->id }}">
                                                ...
                                                @if ($review->item)
                                                    <a class="media align-items-center"
                                                        ...
                                                        <div class="media-body">
                                                            ...
                                                            <!-- Static Order ID -->
                                                            <a class="text-body"
                                                                href="{{ route('admin.order.details', ['id' => $review->order_id]) }}">Order
                                                                ID: {{ $review->order_id }}</a>
                                                            <!-- Static Order ID -->
                                                        </div>
                                                    </a>
                                                @else
                                            ...
                                            <td>
                                                ...
                                                <p class="text-wrap review-comment" data-toggle="tooltip"
                                                    data-placement="left" data-original-title="{{ $review?->comment }}">
                                                    {!! $review->comment ? Str::limit($review->comment, 30, '...') : '' !!}</p>
                                            </td>
                                            <td>
                                                {{ \App\CentralLogics\Helpers::time_date_format($review->created_at) }}
                                            </td>
                                            <td>
                                                <p class="text-wrap text-center" data-toggle="tooltip"
                                                    data-placement="top" data-original-title="{{ $review?->reply }}">
                                                    {!! $review->reply ? Str::limit($review->reply, 50, '...') : translate('messages.Not_replied_Yet') !!}</p>
                                            </td>
