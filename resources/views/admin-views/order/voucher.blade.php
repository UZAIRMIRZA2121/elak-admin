                ...
                <table id="datatable"
                    ...
                    <thead class="thead-light">
                        <tr>
                            ...
                            <th class="table-column-pl-0 border-0">{{ translate('messages.segment') }}</th>
                            <th class="table-column-pl-0 border-0">{{ translate('messages.partner') }}</th>
                            <th class="table-column-pl-0 border-0">{{ translate('messages.city') }}</th>
                            <th class="table-column-pl-0 border-0">{{ translate('messages.major_city') }}</th>
                            <th class="table-column-pl-0 border-0">{{ translate('messages.voucher_desc') }}</th>
                            <th class="table-column-pl-0 border-0">{{ translate('messages.created_at') }}</th>
                    ...
                    <tbody id="set-rows">
                        @foreach ($orders as $key => $order)
                            <tr class="status-{{ $order['order_status'] }} class-all">
                                ...
                                <td>
                                    <strong>
                                        <div> {{ $order->customer->segment->name ?? '' }}
                                        </div>
                                    </strong>
                                </td>
                                <td>
                            ...
                            <select name="vendor[]" id="vendor_ids" class="form-control js-select2-custom"
                                ...
                                @foreach (\App\Models\Store::WithoutModule('rental')->get(['id', 'name']) as $store)
                                    <option value="{{ $store->id }}"
                                        @if (isset($vendor_ids) && in_array($store->id, $vendor_ids)) selected @endif>
                                        {{ $store->name }}
                                    </option>
                                @endforeach
                            </select>
