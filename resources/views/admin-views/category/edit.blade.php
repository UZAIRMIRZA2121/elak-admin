                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-check form-switch mb-3">
                                ...
                                <input type="checkbox" class="form-check-input" name="schedule_status"
                                    id="schedule_status" {{ old('schedule_status', $category['schedule_status']
                                    ?? 'inactive' )=='active' ? 'checked' : '' }}>
                                <label class="form-check-label" for="schedule_status">
                                    {{ old('schedule_status', $category['schedule_status'] ?? 'inactive') == 'active' ?
                                    'Active' : 'Inactive' }}
                                </label>
                            </div>
                            ...
                            <div id="scheduleFields"
                                class="{{ old('schedule_status', $category['schedule_status'] ?? 'inactive') == 'active' ? '' : 'd-none' }}">
                        ...
                        <select name="tax_ids[]" required id="tax__rate" class="form-control js-select2-custom"
                            ...
                            <option {{ in_array($taxVat['id'], $taxVatIds) ? 'selected' : '' }} value="{{ $taxVat['id'] }}">
                                {{ $taxVat['name'] }}
                                ({{ $taxVat['tax_rate'] }}%)
                            </option>
                            @endforeach
                        ...
                        <div class="form-group mt-3">
                            ...
                            <select name="zone_ids[]" id="zone_ids" class="form-control js-select2-custom"
                                ...
                                <option value="{{ $zone->id }}" {{ isset($category['zone_ids']) && in_array($zone->id,
                                    explode(',', $category['zone_ids'])) ? 'selected' : '' }}>{{ $zone->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="h-100 d-flex align-items-center flex-column">
                            ...
                            <label class="text-center my-auto position-relative d-inline-block">
                                <img class="img--176 border" id="viewer" src="{{ $category['image_full_url'] }}"
                                    data-onerror-image="{{asset('public/assets/admin/img/upload-img.png')}}" alt="" />
