                                    ...
                                    <div class="row g-3">
                                        <div class="col-12 d-flex justify-content-between">
                                            <span class="d-flex g-1">
                                                <img src="{{ asset('public/assets/admin/img/other-banner.png') }}"
                                                    class="h-85" alt="">
                                        ...
                                        <div class="col-12">
                                            <label class="__upload-img aspect-4-1 m-auto d-block">
                                                <div class="img">
                                                    <img class="onerror-image"
                                                        src="{{ asset('/public/assets/admin/img/upload-placeholder.png') }}"
                                            ...
                                            <div class="text-center mt-5">
                                                ...
                                                <p>{{ translate('image_format_:_jpg_,_png_,_jpeg_|_maximum_size:_2_MB') }}
                                                </p>
                                            ...
                                            @foreach ($banners as $key => $banner)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <form
                                                            action="{{ route('admin.promotional-banner.update-status', [$banner->id, $banner->status ? 0 : 1]) }}"
                                                    ...
                                                    <td>
                                                        <div class="btn--container justify-content-center">
                                                            <a class="btn action-btn btn--primary btn-outline-primary"
                                                                href="{{ route('admin.promotional-banner.edit', [$banner['id']]) }}">
                                                                <i class="tio-edit"></i>
                                                            </a>
                                                            ...
                                                            <form
                                                                action="{{ route('admin.promotional-banner.delete', [$banner['id']]) }}"
