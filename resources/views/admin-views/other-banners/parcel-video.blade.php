                                    ...
                                    <div class="col-md-6 lang_form default-form">
                                        <div class="row g-3">
                                            <div class="col-12">
                                                ...
                                                <input type="text" id="section_title" maxlength="20"
                                                    name="section_title[]"
                                                    value="{{ $section_title?->getRawOriginal('value') }}"
                                                    class="form-control"
                                        ...
                                        <div class="col-md-6 d-none lang_form" id="{{ $lang }}-form1">
                                            <div class="row g-3">
                                                <div class="col-12">
                                                    ...
                                                    <input type="text" id="section_title{{ $lang }}"
                                                        maxlength="20" name="section_title[]"
                                        ...
                                        <div class="resturant-type-group border">
                                            <label class="form-check form--check mr-2 mr-md-4">
                                                <input class="form-check-input" type="radio" value="video"
                                                    name="banner_type"
                                                    {{ $banner_type ? ($banner_type->value == 'video' ? 'checked' : '') : '' }}>
                                                <span class="form-check-label">
                                                    {{ translate('YouTube_Video_URL') }} <span
                                            ...
                                            <label class="form-check form--check mr-2 mr-md-4">
                                                <input class="form-check-input" type="radio" value="video_content"
                                                    name="banner_type"
                                                    {{ $banner_type ? ($banner_type->value == 'video_content' ? 'checked' : '') : '' }}>
                                                <span class="form-check-label">
                                                    {{ translate('video') }}
                                                </span>
                                            </label>
                                            <label class="form-check form--check mr-2 mr-md-4">
                                                <input class="form-check-input" type="radio" value="image"
                                                    name="banner_type"
                                                    {{ $banner_type ? ($banner_type->value == 'image' ? 'checked' : '') : '' }}>
                                                <span class="form-check-label">
                                                    {{ translate('image') }}
                                                </span>
                                            </label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row g-3 __bg-F8F9FC-card">
                                            <div class="col-sm-6">
                                                ...
                                                <input type="text" id="content1_title" maxlength="80"
                                                    name="content1_title[]"
                                                    value="{{ $content1_title?->getRawOriginal('value') }}"
                                                    class="form-control"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row g-3 __bg-F8F9FC-card">
                                            <div class="col-sm-6">
                                                ...
                                                <input type="text" id="content2_title" maxlength="80"
                                                    name="content2_title[]"
                                                    value="{{ $content2_title?->getRawOriginal('value') }}"
                                                    class="form-control"
                                                    placeholder="{{ translate('Ex_:_Enter_Title') }}">
                                            </div>
                                            <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row g-3 __bg-F8F9FC-card">
                                            <div class="col-sm-6">
                                                ...
                                                <input id="content3_title" type="text" maxlength="80"
                                                    name="content3_title[]"
                                                    value="{{ $content3_title?->getRawOriginal('value') }}"
                                                    class="form-control"
                                                    placeholder="{{ translate('Ex_:_Enter_Title') }}">
                                            </div>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row g-3 __bg-F8F9FC-card">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" id="content1_title{{ $lang }}"
                                                        maxlength="80" name="content1_title[]"
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" id="content1_subtitle{{ $lang }}"
                                                        maxlength="240" name="content1_subtitle[]"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row g-3 __bg-F8F9FC-card">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" id="content2_title{{ $lang }}"
                                                        maxlength="80" name="content2_title[]"
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" id="content2_subtitle{{ $lang }}"
                                                        maxlength="240" name="content2_subtitle[]"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row g-3 __bg-F8F9FC-card">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" id="content3_title{{ $lang }}"
                                                        maxlength="80" name="content3_title[]"
