            ...
            <div class="tab-pane fade show active">
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{ route('admin.promotional-banner.why-choose-update', [$banner['id']]) }}"
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea type="text" maxlength="100" name="short_description[]" class="form-control" rows="3"
                                                        {{ translate('messages.short_description_here...') }}> {{ $banner?->getRawOriginal('short_description') ?? '' }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row d-none lang_form" id="{{ $lang }}-form1">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" maxlength="80" name="title[]"
                                                            value="{{ $translate[$lang]['title'] ?? '' }}"class="form-control"
                                                            placeholder="{{ translate('messages.title_here...') }}">
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea type="text" maxlength="100" name="short_description[]" class="form-control" rows="3"
                                                            {{ translate('messages.short_description_here...') }}> {{ $translate[$lang]['short_description'] ?? '' }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="ml-5">
                                        ...
                                        <label class="upload-img-3 m-0">
                                            <div class="img">
                                                <img src="{{ $banner['image_full_url'] ?? asset('/public/assets/admin/img/aspect-1.png') }}"
