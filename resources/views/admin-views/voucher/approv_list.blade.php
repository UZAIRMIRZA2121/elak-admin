                ...
                <div class="search--button-wrapper justify-content-end">
                    ...
                    <div class="hs-unfold mr-2">
                        ...
                        <div id="usersExportDropdown"
                            ...
                            <a id="export-excel" class="dropdown-item" href="{{ route('admin.Voucher.export', ['type' => 'excel', 'table'=>'TempProduct' , request()->getQueryString()]) }}">
                                <img class="avatar avatar-xss avatar-4by3 mr-2"
                                    src="{{ asset('public/assets/admin') }}/svg/components/excel.svg"
                                    alt="Image Description">
                                {{ translate('messages.excel') }}
                            </a>
                            <a id="export-csv" class="dropdown-item" href="{{ route('admin.Voucher.export', ['type' => 'csv',  'table'=>'TempProduct' , request()->getQueryString()]) }}">
                                <img class="avatar avatar-xss avatar-4by3 mr-2"
                ...
                <table id="datatable" class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table"
                    ...
                    @foreach($items as $key=>$item)
                        <tr>
                            ...
                            <td>
                                <a class="media align-items-center" href="{{route('admin.Voucher.requested_item_view',['id'=> $item['id']])}}">
                            ...
                            <td>
                                <div class="btn--container justify-content-center">
                                    ...
                                    data-original-title="{{ translate('messages.View') }}" href="{{route('admin.Voucher.requested_item_view',['id'=> $item['id']])}}">
                                    ...
                                    data-url="{{route('admin.Voucher.approved',[ 'id'=> $item['id']])}}" data-message="{{translate('messages.you_want_to_approve_this_product')}}"
                                    ...
                                    @if($item->is_rejected == 0)
                                        ...
                                        data-original-title="{{ translate('messages.deny') }}" data-url="{{ route('admin.Voucher.deny', ['id'=> $item['id']]) }}" data-message="{{ translate('you_want_to_deny_this_product') }}"
                                        href="javascript:"><i class="tio-clear font-weight-bold"></i></a>
                                    @endif
                                    <a class="btn action-btn btn--primary btn-outline-primary"
                                        href="{{route('admin.Voucher.edit',[$item['id'], 'temp_product' => true])}}" title="{{translate('messages.edit_item')}}"><i class="tio-edit"></i>
                                    </a>
                                    ...
                                    <form action="{{route('admin.Voucher.delete',[$item['id']])}}"
