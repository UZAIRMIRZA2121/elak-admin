                    ...
                    <div class="w-70 flex-grow">
                        <div class="d-flex justify-content-end">
                            <div class="d-flex flex-wrap gap-2 align-items-start">
                                <a href="{{ route('admin.Voucher.edit', [$product['id'],'temp_product' => true]) }}" class="btn btn-sm btn-- btn-outline-primary">
                                    <i class="tio-redo font-weight-bold "></i>  {{ translate('messages.Edit_&_Approve') }}
                                </a>
                                @if($product->is_rejected == 0)
                                <a data-toggle="tooltip" data-placement="top"
                                data-original-title="{{ translate('messages.Reject') }}" data-url="{{ route('admin.Voucher.deny', ['id'=> $product['id']]) }}" data-message="{{ translate('you_want_to_deny_this_product') }}"
                                ...
                                data-original-title="{{ translate('messages.approve') }}"
                                    data-url="{{route('admin.Voucher.approved',[ 'id'=> $product['id']])}}" data-message="{{translate('messages.you_want_to_approve_this_product')}}"
