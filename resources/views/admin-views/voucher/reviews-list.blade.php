    ...
    <div class="content container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-header border-0 py-2">
                <h5 class="card-title">
                    {{ translate('messages.Review_list') }}<span class="badge badge-soft-dark ml-2"
                        id="itemCount">{{ $reviews->total() }}</span></h5>
                <div class="search--button-wrapper justify-content-end">
                    <form class="search-form">
                        <!-- Search -->
                        <div class="input-group input--group">
                            <input id="datatableSearch" name="search" value="{{ request()?->search ?? null }}"
                                type="search" class="form-control min-height-45"
                                placeholder="{{ translate('ex_:_search_item_Name,_customer_Name,_Rating') }}"
                    ...
                    <div class="hs-unfold mr-2">
                        ...
                        <div id="usersExportDropdown"
                            ...
                            <a id="export-excel" class="dropdown-item"
                                href="{{ route('admin.Voucher.reviews_export', ['type' => 'excel', request()->getQueryString()]) }}">
                            ...
                            <a id="export-csv" class="dropdown-item"
                                href="{{ route('admin.Voucher.reviews_export', ['type' => 'csv', request()->getQueryString()]) }}">
                                <img class="avatar avatar-xss avatar-4by3 mr-2"
                    ...
                    <table id="columnSearchDatatable"
                        ...
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th>{{ translate('messages.visibility') }}</th>
                        ...
                        <tbody>
                            @foreach ($reviews as $key => $review)
                                <tr id="review-row-{{ $review->id }}">
                                    ...
                                    <td class="d-flex">
                                        @if ($review->item)
                                            <a class="media align-items-center mb-1"
                                                href="{{ route('admin.Voucher.view', [$review->item['id']]) }}">
                                    ...
                                    <td>
                                        <label class="rating ">
                                            <span class="review-rating">{{ $review->rating }} </span> <i
                                                class="tio-star m-sm-auto"></i>
                                        </label>
                                        <p class="text-wrap review-comment" data-toggle="tooltip" data-placement="left"
                                    ...
                                    <td>
                                        ...
                                        <form
                                            action="{{ route('admin.Voucher.reviews.status', [$review['id'], $review->status ? 0 : 1]) }}"
                                            method="get" id="status-{{ $review['id'] }}">
                                        </form>
                                    </td>
                                    <td>
                                        <a href="javascript:void(0);"
                                            class="btn action-btn btn--primary btn-outline-primary edit-review-btn"
