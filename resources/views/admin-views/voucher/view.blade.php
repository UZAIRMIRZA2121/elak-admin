        ...
        <div class="page-header">
            <div class="d-flex flex-wrap justify-content-between">
                ...
                <div>
                    ...
                    <a href="{{ route('admin.Voucher.edit', [$product['id']]) }}" class="btn btn--primary">
                ...
                <div class="hs-unfold mr-2">
                    ...
                    <div id="usersExportDropdown"
                        ...
                        <a id="export-excel" class="dropdown-item"
                            href="{{ route('admin.Voucher.item_wise_reviews_export', ['type' => 'excel', 'store' => $product->store?->name, 'id' => $product['id'], request()->getQueryString()]) }}">
                        ...
                        <a id="export-csv" class="dropdown-item"
                            href="{{ route('admin.Voucher.item_wise_reviews_export', ['type' => 'csv', 'store' => $product->store?->name, 'id' => $product['id'], request()->getQueryString()]) }}">
                            <img class="avatar avatar-xss avatar-4by3 mr-2"
