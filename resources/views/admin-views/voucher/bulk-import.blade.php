...
@section('content')
    <div class="content container-fluid">
        ...
        <br>
        <form class="product-form" id="import_form" action="{{route('admin.Voucher.bulk-import')}}" method="POST"
...
$('#reset_btn').click(function(){
    ...
    $('#item_form_2').on('submit', function(e) {
        ...
        $.post({
            url: '{{ route('admin.Voucher.variation-generate') }}',
    ...
    $('#item_form').on('submit', function(e) {
        ...
        $.post({
            url: '{{ route('admin.Voucher.food-variation-generate') }}',
