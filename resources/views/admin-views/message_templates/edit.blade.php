...
@section('title'," Message Template Edit")
...
<style>
    ...
    <div class="content container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{route('admin.MessageTemplate.update',[$MessageTemplate['id']])}}" method="post" enctype="multipart/form-data">
                    @csrf
                                    ...
                                    <div class="col-6 ">
                                        <div class="lang_form" id="default-form">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="title" value="{{$MessageTemplate->title}}" id="title" class="form-control"  placeholder="Enter Message Template">
                                            </div>
                                  ...
                                  <div class="col-6 col-md-4">
                                    <div class="lang_form" id="default-form">
                                        <div class="form-group">
                                            ...
                                            @if(!empty($MessageTemplate->icon))
                                                <div class="mt-2">
                                                    <img src="{{ asset($MessageTemplate->icon) }}"
                                                        alt="Client Logo"
                                                        class="img-thumbnail"
