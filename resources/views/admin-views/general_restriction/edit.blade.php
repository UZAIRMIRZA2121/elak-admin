...
<style>
    ...
    <div class="content container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{route('admin.GeneralResteiction.update',[$GeneralRestriction['id']])}}" method="post" enctype="multipart/form-data">
                    @csrf
                                ...
                                <div class="col-6 ">
                                    <div class="lang_form" id="default-form">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" value="{{$GeneralRestriction->name}}" id="name" class="form-control"  placeholder="Enter Gift Occasions">
                                        </div>
