...
class ClientDashboardController extends Controller
{
    ...
    public function dashboard(Request $request)
    {
        ...
        return view("client-views.dashboard-grocery", compact('data', 'total_sell', 'commission', 'delivery_commission', 'label','params','module_type'));


        // return view("client-views.dashboard-grocery");
