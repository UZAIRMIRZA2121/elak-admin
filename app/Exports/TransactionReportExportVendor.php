...
class TransactionReportExportVendor implements FromView, ShouldAutoSize, WithStyles, WithColumnWidths, WithHeadings, WithEvents
{
    ...
    public function view(): View
    {
        ...
        return view('file-exports.transaction-report-vendor', [
            'data' => $this->data,
        ]);
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->getStyle('A5:L5')->getFill()->applyFromArray([
            'fillType' => 'solid',
            'rotation' => 0,
            'color' => ['rgb' => '9F9F9F'],
        ]);
        ...
        return [
            ...
            'A1:L' . $this->data['order_transactions']->count() + 5 => [
                'borders' => [
                    'allBorders' => [
    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $event->sheet->getStyle('A4:L' . $this->data['order_transactions']->count() + 5)
                    ->getAlignment()
                    ->setHorizontal(Alignment::HORIZONTAL_CENTER)
                    ->setVertical(Alignment::VERTICAL_CENTER);
